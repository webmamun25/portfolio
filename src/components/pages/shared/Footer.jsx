...
<footer className="footer flex justify-evenly p-10 bg-neutral text-neutral-content">
  ...
  <nav>
    ...
    <div className="grid grid-flow-col gap-4">
      <a><svg className="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
